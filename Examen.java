public class Examen
{
    ...
    {
        // Ejemplo profesora:
        ClaseRosana Rosana = new ClaseRosana("Ros");
        Rosana.escribirnombre();
/*
...
*/
        ...
        ClaseJulen Julen = new ClaseJulen("Julen");
        Julen.escribirnombre();

        ClaseDavid David = new ClaseDavid("Aznar");
        David.escribirnombre();

        ClaseRuben Ruben = new ClaseRuben("Berdejo");
        Ruben.escribirnombre();
...
*/
        ...
        ClaseJimenez Jimenez = new ClaseJimenez("Ainhoa");
        Jimenez.escribirnombre();

        ClaseKeye Keye = new ClaseKeye("Daniel");
        Keye.escribirnombre();
...
*/
        ...
        ClaseValero Valero = new ClaseValero("Valero");
        Valero.escribirnombre();
